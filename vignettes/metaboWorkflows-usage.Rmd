...
The default parameters for a particular workflow can be retrieved using the `workflowParameters()` function. For instance, the `FIE_HRMSfingerprinting` workflow can be retrieved using the following. 
...
This requires the input of the paths to the data files, info file and the workflow parameters.
An example of a suitable file and info input paths is shown below. 
