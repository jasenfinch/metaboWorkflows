...
`_targets.R` - This script contains the formal definition of the workflow. This script sets options for the workflow as well as sources all the necessary scripts in the project directory.
